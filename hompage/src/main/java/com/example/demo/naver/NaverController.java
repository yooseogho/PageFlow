...
public class NaverController {
  ...
  private final static String CLIENT_ID = "UeWhEVUVR1LQ49zv1oti"; // 클라이언트 아이디
  private final static String CLIENT_SECRET = "lzrGjZOaiy";       // 클라이언트 시크릿
  private final static String REDIRECT_URI = "http://localhost:8081/member_login_page"; // 리다이렉트 페이지
  private final static String SESSION_STATE = "oauth_state";                            // 이건 뭐야
