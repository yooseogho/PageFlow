...
public interface OrderDetailsDao {
	// 주문 상세 생성
	@Insert("INSERT INTO order_details (ono, bno, order_count, order_total, book_title, odno, order_status) VALUES (#{ono}, #{bno}, #{orderCount}, #{orderTotal}, #{bookTitle}, #{odno}, #{orderStatus})")
