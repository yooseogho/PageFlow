                                        ...
                                        <td>
                                            <div class="col_box">
                                                <div class="valid_check">
                                                    <input data-kbbfn-field="" id="notice-title" type="text" class="form_ip w_full" title="제목 입력" placeholder="제목을 입력해 주세요." maxlength="30">
                                                ...
                                                <div class="col_box">
                                                    <div class="valid_check">
                                                        <div class="byte_check_wrap w_full">
                                                            <textarea data-kbbfn-field="" id="summernote" class="form_textarea" title="공지 내용 입력" placeholder="공지할 내용을 입력해주세요." maxlength="3000" style="height: 246px;"></textarea>
