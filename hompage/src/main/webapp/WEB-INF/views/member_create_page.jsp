	...
	<div id="page">
		...
		<main class="container_wrapper">
			...
			<section class="contents_wrap">
				<form action="/member_create_page" method="post">
						...
						<div id="join_form_insert">
								...
								<div class="form_cont">
									<div class="valid_check">
										<div class="awesomplete">
											<input type="text" class="form_ip" id="formJoin01"
								...
								<div class="form_cont">
									...
									<div class="pw_valid_wrap">
										...
										<ul class="pw_valid_list">
											...
											<li class="pw_valid_item" style="display: none;">생일,
												전화번호, 아이디 등 개인신상 정보 사용 불가</li>
										</ul>
									</div>
								</div>
							</div>
									...
									<div class="form_col_group">
										<div class="col_box">
											<div class="valid_check success">
												<div class="input_btn_box">
													<div class="awesomplete">
														<input type="email" id="formJoin08" name="memberEmail"
							...
							<div class="form_box">
								...
								<div class="form_cont">
									<div class="valid_check">
										<div class="input_btn_box">
											<input type="text" maxlength="8" id="formJoin06"
