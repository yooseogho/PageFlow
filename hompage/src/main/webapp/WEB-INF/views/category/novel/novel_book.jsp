...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="/css/book/novel/novel_book.css">
		...
		<main class="container_wrapper">
            <div class="main_inner">
                <aside class="aside_wrap sub_category">
                   <jsp:include page="/WEB-INF/views/include/product_left_aside.jsp" />
                </aside>
                                                            ...
                                                            <div class="prod_info_box">
                                                                ...
                                                                <div class="prod_author_info">
                                                                    <div class="auto_overflow_wrap prod_author_group">
                                                                        <div class="auto_overflow_contents">
                                                                            <div class="auto_overflow_inner">
                                                                                <a href="https://localhost:8081/author_book_page" class="author rep">김진명</a>
                                                                ...
                                                                <div class="prod_publish">
                                                                    <a href="https://localhost:8081/publisher_page" class="text">이타북스</a>
                                                                    <span class="gap">·</span>
                                                            ...
                                                            <div class="prod_info_box">
                                                                ...
                                                                <div class="prod_author_info">
                                                                    <div class="auto_overflow_wrap prod_author_group">
                                                                        <div class="auto_overflow_contents">
                                                                            <div class="auto_overflow_inner">
                                                                                <a href="https://localhost:8081/author_book_page" class="author rep">최윤석</a>
                                                                                <span class="type">저자(글)</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <!-- 상품의 출판사 소개 -->
                                                                <div class="prod_publish">
                                                                    <a href="https://localhost:8081/publisher_page" class="text">포레스트북스</a>
                                                                    <span class="gap">·</span>
                                                            ...
                                                            <div class="prod_info_box">
                                                                ...
                                                                <div class="prod_author_info">
                                                                    <div class="auto_overflow_wrap prod_author_group">
                                                                        <div class="auto_overflow_contents">
                                                                            <div class="auto_overflow_inner">
                                                                                <a href="https://localhost:8081/author_book_page" class="author rep">조예은</a>
                                                                                <span class="type">저자(글)</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <!-- 상품의 출판사 소개 -->
                                                                <div class="prod_publish">
                                                                    <a href="https://localhost:8081/publisher_page" class="text">안전가옥</a>
                                                                    <span class="gap">·</span>
                                                            ...
                                                            <div class="prod_info_box">
                                                                ...
                                                                <div class="prod_author_info">
                                                                    <div class="auto_overflow_wrap prod_author_group">
                                                                        <div class="auto_overflow_contents">
                                                                            <div class="auto_overflow_inner">
                                                                                <a href="https://localhost:8081/author_book_page" class="author rep">염비</a>
                                                                                <span class="type">저자(글)</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <!-- 상품의 출판사 소개 -->
                                                                <div class="prod_publish">
                                                                    <a href="https://localhost:8081/publisher_page" class="text">파피루스</a>
                                                                    <span class="gap">·</span>
                                                            ...
                                                            <div class="prod_info_box">
                                                                ...
                                                                <div class="prod_author_info">
                                                                    <div class="auto_overflow_wrap prod_author_group">
                                                                        <div class="auto_overflow_contents">
                                                                            <div class="auto_overflow_inner">
                                                                                <a href="https://localhost:8081/author_book_page" class="author rep">박하령</a>
                                                                                <span class="type">저자(글)</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <!-- 상품의 출판사 소개 -->
                                                                <div class="prod_publish">
                                                                    <a href="https://localhost:8081/publisher_page" class="text">책폴</a>
                                                                    <span class="gap">·</span>
