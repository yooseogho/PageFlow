					...
					<div class="customer_wrap">
						...
						<div class="title_wrap title_size_md">
							...
							<div class="right_area">
								<a href="#" class="btn_more_view size_lg"><span class="text">더보기</span><span
							...
							<div class="input_btn_box">
								<div class="form_ip_search">
									<input type="search" class="form_ip" title="자주 묻는 질문"
										data-input="onk-cscenter-search-input"
										placeholder="질문을 검색해 보세요.">
								</div>
								<button type="button" id="mainFaqSearchBtn"
						...
						<div class="inquiry_box">
							<div class="box bg">
								<a href="/customer_inquiry_write_page" class="inquiry"> <span
									class="ico_inquiry01"></span>
									<p class="name">1:1 문의 접수</p>
								</a> <a href="/customer_inquiry_list_page" class="inquiry"> <span
									class="ico_inquiry02"></span>
						...
						<div class="title_wrap title_size_md">
							...
							<div class="right_area">
								<a href="/customer_notice_list_page"
									class="btn_more_view size_lg"><span class="text">더보기</span><span
									class="ico_arw"></span></a>
							</div>
						</div>
						...
						<div class="customer_content_area">
							<div class="round_gray_box type_sub_sm company_tel">
								...
								<div class="form_search_box">
									<div class="form_ip_search">
										<input type="search" id="telInfoM" class="form_ip"
											data-input="onk-cscenterArs-search-input"
											placeholder="출판사명 또는 ISBN-13을 입력해 보세요" title="출판사 연락처 안내">
									</div>
						...
						<div class="shortcut_service">
							<ul>
								<li><a href="/member_check_page"> <span
										class="ico_shortcut02"></span> <span class="text">회원정보
											수정</span>
								</a></li>
								<li><a href="/member_grade_page"> <span
										class="ico_shortcut07"></span> <span class="text">회원
											등급별 혜택</span>
								</a></li>
								<li><a href="/find_id_page"> <span
										class="ico_shortcut11"></span> <span class="text">아이디/비밀번호
											찾기</span>
								</a></li>
							</ul>
						</div>
