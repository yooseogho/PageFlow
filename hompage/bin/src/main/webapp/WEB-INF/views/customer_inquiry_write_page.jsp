...
<script src="script/customer_inquiry_write.js"></script>
</head>
					...
					<div class="customer_wrap">
						...
						<form action="/customer_inquiry_write_page" method="post">
														...
														<div class="form_cont">
															<div class="valid_check w_full">
																<div class="form_sel_multi">
																	<div class="form_sel">
																		<select data-kbbfn-field="" id="InquiryQuestList"
																			title="문의유형 분류" name="inquiryType">
												...
												<div class="form_col_group w_full">
													<div class="col_box">
														<div class="valid_check">
															<input data-kbbfn-field="" id="inquiryTitle" type="text"
																class="form_ip w_full" title="제목 입력"
																placeholder="제목을 입력해 주세요." maxlength="30"> <span
														...
														<div class="valid_check">
															<div class="byte_check_wrap w_full">
																<textarea data-kbbfn-field="" id="InquiryContent"
																	...
																	style="height: 246px;" name="content"></textarea>
														...
														<div class="form_cont">
															<ul class="chk_row_list">
																<li class="chk_row_item"><span class="form_rdo">
																		...
																		name="InquiryPhoneType" type="radio" value="phone">
											...
											<td>
												<div class="valid_check">
													<input data-kbbfn-form="inquiryForm" data-kbbfn-field=""
														...
														placeholder="이메일을 입력해 주세요." title="이메일 입력"> <span
														class="valid_desc"></span>
												</div>
											</td>
										</tr>
							...
							<div class="btn_wrap page_bottom">
								...
								<button id="submitInquiry" type="button"
									class="btn_primary btn_lg">
						...
						<div class="info_text_box size_lg">
							...
							<ul class="bul_list">
								...
								<li class="bul_item_dot font_size_xxs"><span> 당일 17시
										이후 문의건과 공휴일 1:1 문의는 문의 유형과 이름/연락처/이메일 주소를 남겨 주시면 확인 후 운영시간에
										통지해 드립니다. </span></li>
								...
								<li class="bul_item_dot font_size_xxs"><span
									class="fw_bold">설/추석 연휴 기간 동안은 고객센터 휴무로 인해 1:1 문의 답변이 불가
										합니다.</span></li>
								<li class="bul_item_dot font_size_xxs"><span
									class="fw_bold">설/추석 연후 끝난 이후부터 순차적으로 답변드릴 예정이니 양해
										부탁드립니다.</span></li>
								<li class="bul_item_dot font_size_xxs"><span
									class="fw_bold">신학기(3월, 9월), 코로나로 인해 문의량이 급증하여 답변이 지연될 수
										있습니다.</span></li>
							</ul>
						</div>
					</div>
