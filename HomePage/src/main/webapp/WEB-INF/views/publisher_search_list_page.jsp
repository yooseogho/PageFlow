                                       ...
                                       <!-- 상품들 리스트 영역 -->
                                            ...
                                            <div class="pagination">
                                                <c:if test="${page.prev>0}">
                                                    <button class="btn_page prev" href="/book/search/publisher?keyword=${page.keyword}&pageno=${page.prev}">
                                                ...
                                                <div class="page_num">
                                                    <c:forEach begin="${page.start}" end="${page.end}" var="i">
                                                        <c:if test="${i== page.pageno}">
                                                            <a href="/book/search/publisher?keyword=${page.keyword}&pageno=${i}" class="btn_page_num active">${i}</a>
                                                        </c:if>
                                                        <c:if test="${i != page.pageno}">
                                                            <a href="/book/search/publisher?keyword=${page.keyword}&pageno=${i}" class="btn_page_num">${i}</a>
                                                        </c:if>
                                                    </c:forEach>
                                                </div>
                                                <c:if test="${page.next>0}">
                                                    <button class="btn_page next" href="/book/search/publisher?keyword=${page.keyword}&pageno=${page.next}">
