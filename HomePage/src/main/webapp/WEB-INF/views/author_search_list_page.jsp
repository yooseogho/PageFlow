                    ...
                    <div class="search_result_top">
                        <div class="title_wrap title_size_lg">
                            <h1 class="title_heading">
                                <span class="fc_green">'<span class="search_value">${page.keyword}</span>'</span>에 대한 검색 결과
                            </h1>
                                       ...
                                       <!-- 상품들 리스트 영역 -->
                                                	...
                                                	<c:choose>
		                                                           ...
		                                                           <div class="prod_area horizontal">
		                                                               ...
		                                                               <div class="prod_info_box">
		                                                                   ...
		                                                                   <div class="prod_publish">
		                                                                       ...
		                                                                       <span class="gap">·</span>
		                                                                       <span class="date" data-release-date="${book.publishDate.substring(0, 10)}">${book.publishDate.substring(0, 10) }</span>
		                                                                   </div>
		                                                                   ...
		                                                                   <div class="prod_price">
		                                                                       <span class="price_normal">
		                                                                           ...
		                                                                           <span class="val" data-price="${book.bookPrice }">
		                                                                       ...
		                                                                       <span class="point">
		                                                                           ...
		                                                                           <span class="rate">(<fmt:formatNumber type="percent" value="${book.pointRate }" />)
		                                                                           </span>
		                                                                       </span>
		                                                ...
		                                                <c:otherwise>
		                                                	<div class="switch_prod_wrap view_type_list">
															    <div class="no_data has_desc_lg has_line">
															        <div class="no_data_desc_lg">
																        <span class="fw_bold">
																    	    <span class="search_value">${page.keyword }</span>
																        </span>에 대한 검색 결과가 없습니다.
															        </div>
															        <div class="no_data_desc">검색어의 철자가 정확한지 다시 한 번 확인해주세요. <br>
                                            ...
                                            <div class="pagination">
                                                <c:if test="${page.prev>0}">
                                                    <button class="btn_page prev" href="/book/search/authorName?keyword=${page.keyword}&pageno=${page.prev}">
                                                ...
                                                <div class="page_num">
                                                    <c:forEach begin="${page.start}" end="${page.end}" var="i">
                                                        <c:if test="${i== page.pageno}">
                                                            <a href="/book/search/authorName?keyword=${page.keyword}&pageno=${i}" class="btn_page_num active">${i}</a>
                                                        </c:if>
                                                        <c:if test="${i != page.pageno}">
                                                            <a href="/book/search/authorName?keyword=${page.keyword}&pageno=${i}" class="btn_page_num">${i}</a>
                                                        </c:if>
                                                    </c:forEach>
                                                </div>
                                                <c:if test="${page.next>0}">
                                                    <button class="btn_page next" href="/book/search/authorName?keyword=${page.keyword}&pageno=${page.next}">
