            ...
            <div class="main_inner">
                ...
                <section class="section_wrapper">
                    <div class="admin_wrap">
                            ...
                            <div class="admin_search_wrap">
                                <div class="admin_search_box">
                                	<form id="adminSearchForm" action="/admin/book/list/search" method="get">
                                   		<input id="searchKeyword" type="search" class="ip_gnb_search" title="통합검색어 입력" value="" placeholder="검색어를 입력해주세요" name="keyword">
                                   	</form>	
                                </div>
                        ...
                        <div class="title_wrap title_size_md second">
                            <p class="title_heading">${page.keyword}에 대한 검색 결과</p>
                        </div>
                                        ...
                                        <div class="result_area">
                                            ...
                                            <div class="pagination">
                                                <c:if test="${page.prev>0}">
                                                    <button class="btn_page prev" href="/admin/book/list/search?keyword=${page.keyword}&pageno=${page.prev}">
                                                ...
                                                <div class="page_num">
                                                    <c:forEach begin="${page.start}" end="${page.end}" var="i">
                                                        <c:if test="${i== page.pageno}">
                                                            <a href="/admin/book/list/search?keyword=${page.keyword}&pageno=${i}" class="btn_page_num active">${i}</a>
                                                        </c:if>
                                                        <c:if test="${i != page.pageno}">
                                                            <a href="/admin/book/list/search?keyword=${page.keyword}&pageno=${i}" class="btn_page_num">${i}</a>
                                                        </c:if>
                                                    </c:forEach>
                                                </div>
                                                <c:if test="${page.next>0}">
                                                    <button class="btn_page next" href="/admin/book/list/search?keyword=${page.keyword}&pageno=${page.next}">
