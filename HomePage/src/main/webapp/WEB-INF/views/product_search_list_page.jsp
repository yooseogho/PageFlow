                                    ...
                                    <div class="result_area">
                                        <div class="list_result_wrap">
                                            ...
                                            <div class="switch_prod_wrap view_type_list" id="shopData_list">
                                                <ul class="prod_list" id="book-list">
                                                	<c:choose>
                                                ...
                                                <div class="page_num">
                                                    <c:forEach begin="${page.start}" end="${page.end}" var="i">
                                                        <c:if test="${i== page.pageno}">
                                                            <a href="/book/search?keyword=${page.keyword}&pageno=${i}" class="btn_page_num active">${i}</a>
                                                        </c:if>
                                                        <c:if test="${i != page.pageno}">
                                                            <a href="/book/search?keyword=${page.keyword}&pageno=${i}" class="btn_page_num">${i}</a>
                                                        </c:if>
                                                    </c:forEach>
                                                </div>
                                                <c:if test="${page.next>0}">
                                                    <a class="btn_page next" href="/book/search?keyword=${page.keyword}&pageno=${page.next}">
