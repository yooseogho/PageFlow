		...
		<main class="main_wrapper">
			<div class="main_inner">
				...
				<section class="section_wrapper">
					<form action="/admin_inquiry_answer_page/${inno}" method="post">
																...
																<div class="form_sel_multi">
																	<div class="form_sel">
																		<select data-kbbfn-field="" id="InquiryQuestList"
																			title="문의유형 분류">
																			<option value="-1" selected="selected">${inquiry.inquiryType}</option>
																		</select>
																	</div>
																</div>
													...
													<div class="col_box">
														<div class="valid_check">
															<input data-kbbfn-field="" id="InquiryTitle" type="text"
																...
																maxlength="30" value="${inquiry.inquiryTitle}" readonly>
															<span class="valid_desc"></span>
														</div>
													</div>
													<div class="col_box">
														<div class="valid_check">
															<div class="byte_check_wrap w_full">
																<textarea data-kbbfn-field="" id="InquiryContent"
																	...
																	placeholder="문의 내용" maxlength="500"
																	style="height: 246px;" readonly>${inquiry.content}</textarea>
										...
										<tr>
											...
											<td>
												<div class="col_box">
													<div class="valid_check">
														<div class="byte_check_wrap w_full">
															<textarea id="summernote" name="inquiryAnswer"
																class="form_textarea" title="답변 내용 입력" maxlength="3000"
