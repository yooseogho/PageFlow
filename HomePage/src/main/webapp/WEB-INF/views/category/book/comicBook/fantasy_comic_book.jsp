		...
		<main class="container_wrapper">
			<div class="main_inner">
				<aside class="aside_wrap sub_category">
					<jsp:include
						page="/WEB-INF/views/include/book/comicBook/fantasy_comic_left_aside.jsp" />
				</aside>
				...
				<section class="contents_wrap">
					<div class="contents_inner">
						<div class="search_result_top">
							...
							<div
								class="tab_wrap type_line justify ui-tabs ui-corner-all ui-widget ui-widget-content">
											...
											<div class="list_result_wrap">
												...
												<div class="right_area">
													<div class="item_group">
														<button type="button"
															class="btn_sm btn_line_gray btn_cart">
												...
												<ul class="prod_list">
													<c:forEach var="book" items="${page.books }">
														<li class="prod_item"><span class="form_chk no_label">
																...
																id="${book.bno }" type="checkbox" name="chkList">>
															...
															<div class="prod_area horizontal">
																...
																<div class="prod_thumb_box size_lg">
																	<a href="/book/read?bno=${book.bno }" class="prod_link">
																		<span class="img_box"> <img loading="lazy"
																			alt="${book.bookTitle }" src="${book.bookImage }">
																	</span>
																	</a>
																</div>
																...
																<div class="prod_info_box">
																	...
																	<div class="auto_overflow_wrap prod_name_group">
																		<div class="auto_overflow_contents">
																			<div class="auto_overflow_inner">
																				<a href="/book/read?bno=${book.bno }"
																					class="prod_info"> <span class="prod_category">[국내도서]</span>
																	...
																	<div class="prod_author_info">
																		<div class="auto_overflow_wrap prod_author_group">
																			<div class="auto_overflow_contents">
																				<div class="auto_overflow_inner">
																					<a
																						href="/book/search/authorName?keyword=${book.authorName}"
																						class="author rep">${book.authorName }</a> <span
																						class="type">저자(글)</span>
																				</div>
																			</div>
																		</div>
																	</div>
																	...
																	<div class="prod_publish">
																		<a
																			href="/book/search/publisher?keyword=${book.publisherName}"
																			class="text">${book.publisherName }</a> <span
																			class="gap">·</span> <span class="date">${book.publishDate.substring(0, 10) }</span>
																	</div>
																	...
																	<div class="prod_price">
																		<span class="price_normal"> <span class="text">정가</span>
																			<span class="val"> <fmt:formatNumber
																					...
																					value="${book.bookPrice }" />원
																		</span>
																		</span> <span class="gap">|</span> <span class="point">
																			<fmt:formatNumber type="number" pattern="#,##0"
																				value="${book.pointEarnings }" />p <span
																			class="rate">( <fmt:formatNumber
																					type="percent" value="${book.pointRate }" />)
																		</span>
																		</span>
															...
															<div class="prod_btn_wrap">
																<div class="btn_wrap full">
																	<button class="btn_sm btn_light_gray cart_add"
																		data-bno="${book.bno}">
																		<span class="text">장바구니</span>
																	</button>
																	<button class="btn_sm btn_primary order"
																		data-bno="${book.bno}">
											...
											<div class="pagination">
												<c:if test="${page.prev>0}">
													<button class="btn_page prev"
														href="/category/book/${page.categoryParent}/${page.categoryCode}?pageno=${page.prev}">
												...
												<div class="page_num">
													<c:forEach begin="${page.start}" end="${page.end}" var="i">
														<c:if test="${i== page.pageno}">
															<a
																href="/category/book/${page.categoryParent}/${page.categoryCode}?pageno=${i}"
																class="btn_page_num active">${i}</a>
														</c:if>
														<c:if test="${i != page.pageno}">
															<a
																href="/category/book/${page.categoryParent}/${page.categoryCode}?pageno=${i}"
																class="btn_page_num">${i}</a>
														</c:if>
													</c:forEach>
												</div>
												<c:if test="${page.next>0}">
													<button class="btn_page next"
														href="/category/book/${page.categoryParent}/${page.categoryCode}?pageno=${page.next}">
