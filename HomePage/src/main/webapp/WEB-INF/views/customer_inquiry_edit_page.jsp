...
<script>
	window.onload = function() {
		...
		document
				.getElementById('InquiryNotifyCheck')
				.addEventListener(
						'change',
						function() {
							document.getElementById('notifyRequest').value = this.checked;
						});
		...
		document.querySelector('form')
				.addEventListener(
						'submit',
						function(e) {
							var inquiryType = document
									.getElementById('InquiryQuestList').value;
							var inquiryTitle = document
									.getElementById('InquiryTitle').value
									.trim();
							var inquiryContent = document
									.getElementById('InquiryContent').value
									.trim();
							var inquiryPhoneNumber = document
									.getElementById('InquiryPhoneNumber').value
									.trim();
					...
					<div class="customer_wrap">
						...
						<form action="/customer_inquiry_edit_page/${inno}" method="post">
									...
									<tbody>
										<tr>
											<th scope="row" class="has_ip"><label
												for="InquiryQuestList-button">문의유형</label> <span
													...
													<div class="form_box">
														<div class="form_cont">
															<ul class="chk_row_list">
																<li class="chk_row_item"><span class="form_rdo">
																		<input data-kbbfn-form="inquiryForm"
																		data-kbbfn-field="" id="contactPhone1"
																		name="InquiryPhoneType" type="checkbox" value="phone"
														...
														<div class="form_cont">
															...
															<span class="form_chk"> <input
																...
																id="InquiryNotifyCheck" type="checkbox"> <label
																for="InquiryNotifyCheck"> <span>답변알림 요청</span> <span
																	class="fc_gray">(답변이 등록되면 알림톡으로 알려드립니다.)</span>
															</label>
															</span>
														</div>
													</div>
							...
							<div class="btn_wrap page_bottom">
								<a href="/" class="btn_light_gray btn_lg"> <span
									class="text">취소</span>
								</a>
							...
							<div class="info_text_box size_lg">
								...
								<ul class="bul_list">
									<li class="bul_item_dot font_size_xxs"><span>답변은
											마이룸 또는 회원정보에 등록된 이메일로 확인 가능합니다.</span></li>
									<li class="bul_item_dot font_size_xxs"><span> 당일
											17시 이후 문의건과 공휴일 1:1 문의는 문의 유형과 이름/연락처/이메일 주소를 남겨 주시면 확인 후
											운영시간에 통지해 드립니다. </span></li>
									<li class="bul_item_dot font_size_xxs"><span>정상근무일
											기준이며, 통지예정일이 휴일인 경우 다음 정상 근무일에 진행 됩니다.</span></li>
									<li class="bul_item_dot font_size_xxs"><span
										class="fw_bold">설/추석 연휴 기간 동안은 고객센터 휴무로 인해 1:1 문의 답변이
											불가 합니다.</span></li>
									<li class="bul_item_dot font_size_xxs"><span
										class="fw_bold">설/추석 연후 끝난 이후부터 순차적으로 답변드릴 예정이니 양해
											부탁드립니다.</span></li>
									<li class="bul_item_dot font_size_xxs"><span
										class="fw_bold">신학기(3월, 9월), 코로나로 인해 문의량이 급증하여 답변이 지연될
											수 있습니다.</span></li>
								</ul>
							</div>
						</form>
