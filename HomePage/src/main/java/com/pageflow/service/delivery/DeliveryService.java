...
public class DeliveryService {
  ...
  public Boolean deliveryAdd(String memberId, DeliveryDto.Create dto) {
    ...
    Delivery delivery = new Delivery(null, memberId, dto.getZipCode(), dto.getReceiverName(), dto.getDeliveryAddress(),
        dto.getReceiverTel(), null, defaultAddress, dto.getDeliveryName());
