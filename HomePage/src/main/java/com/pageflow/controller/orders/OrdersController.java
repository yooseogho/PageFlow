...
public class OrdersController {
	...
	public ModelAndView order(HttpServletRequest request, Principal principal, Long dno) {
		...
		return new ModelAndView("order_page").addObject("cartList", cartList).addObject("point", point).addObject("delivery", delivery).addObject("memberId", memberId);
	}
	...
	public ModelAndView message(@PathVariable Long dno, DeliveryDto.Message dto, Principal principal, HttpSession session) {
	...
	public ModelAndView orderSuccess(@RequestParam Long ono, HttpSession session) {
		...
		DeliveryDto.Read delivery = (DeliveryDto.Read)session.getAttribute("delivery");
		return new ModelAndView("order_success_page").addObject("list", list).addObject("delivery", delivery).addObject("order", order);
	}
