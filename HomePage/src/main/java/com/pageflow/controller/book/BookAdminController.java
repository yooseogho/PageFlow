...
public class BookAdminController {
	...
	/** 1-3. 상품 등록할 때 아무것도 입력하지 않고 등록 버튼을 누르면 TypeException 오류가 발생함
	 *  그래서 오류 처리를 위한 RedirectAttributes 사용해서 등록했을 때 오류 발생할 경우
	 *  상품 등록에 실패했다는 메세지와 함께 다시 그 페이지를 띄움
	 */
	...
	public ModelAndView adminSearchPage(@RequestParam(required = false) String keyword, @RequestParam(defaultValue = "1") Long pageno) {
