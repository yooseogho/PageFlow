...
public class BookController {
	...
	public ModelAndView CategoryParentList(@PathVariable Long categoryParent,
		...
		return new ModelAndView(viewName).addObject("page", pageData).addObject("count", count).addObject("memberId", memberId);
	...
	public ModelAndView CategoryCodeList(@PathVariable Long categoryParent, @PathVariable Long categoryCode,
		...
		CategoryCodePage pageData = bookService.categoryCodeList(pageno, memberId, gradeCode, categoryCode,
				categoryParent);
	...
	public ModelAndView searListPage(@RequestParam(required = false) String keyword,
		...
		return new ModelAndView("product_search_list_page").addObject("page", pageData).addObject("count", count).addObject("memberId", memberId);
	}
	...
	public ModelAndView AuthorBookList(@RequestParam(required = false) String keyword,
		...
		return new ModelAndView("author_search_list_page").addObject("page", pageData).addObject("count", count).addObject("memberId", memberId);
	}
	...
	public ModelAndView publisheBookList(@RequestParam(required = false) String keyword,
		...
		return new ModelAndView("publisher_search_list_page").addObject("page", pageData).addObject("count", count).addObject("memberId", memberId);
	}
