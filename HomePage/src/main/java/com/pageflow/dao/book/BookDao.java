...
public interface BookDao {
	...
	public List<BookDto.BookList> searchAuthorBook(String authorName, String memberId, Long gradeCode, Long startRownum, Long endRownum);
	...
	public List<BookDto.BookList> searchPublisherBook(String publisherName, String memberId, Long gradeCode, Long startRownum, Long endRownum);
	...
	public List<BookDto.BookList> findBookByCategoryParent(Long categoryParent, String memberId, Long gradeCode, Long startRownum, Long endRownum); 
	
	/** 작품 장르별로 페이징해서 가지고 오기 (book-mapper에 있음) */
	public List<BookDto.BookList> findBookByCategoryCode(Long categoryCode, Long categoryParent, String memberId, Long gradeCode, Long startRownum, Long endRownum);
	...
	public List<BookDto.BookList> searchList(String keyword, String memberId, Long gradeCode, Long startRownum, Long endRownum);
